...
/**
 * Fix: Replaced calculateRegression with calculateWeightedImpulse for higher sensitivity matching indicators.ts root version
...
/**
 * Fix: Updated computeIndicators to match indicators.ts root version, including anchorSlopeMetrics and weighted impulses
 */
